...
import IDS_PAYEMENTS_STATUTS from "../constants/IDS_PAYEMENTS_STATUTS"

export default function statutPayementColor(idStatut) {
          const defaultColor = {
          ...
          const COLORS = {
                    ...
                    [IDS_PAYEMENTS_STATUTS.ENATTENTE_PAYEMENT]: {
                    ...
                    [IDS_PAYEMENTS_STATUTS.COMMANDE]: {
