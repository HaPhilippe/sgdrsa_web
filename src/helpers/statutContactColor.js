...
import IDS_STATUT_CONTACT from "../constants/IDS_STATUT_CONTACT.js"

export default function statutContactColor(idStatut) {
  const defaultColor = {
  ...
  const COLORS = {
    ...
    [IDS_STATUT_CONTACT.NON_REPONDU]: {
