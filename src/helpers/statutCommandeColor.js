...
import IDS_STATUT_COMMANDE from "../constants/IDS_STATUT_COMMANDE.js"

export default function statutCommandeColor(idStatut) {
  const defaultColor = {
  ...
  const COLORS = {
    ...
    [IDS_STATUT_COMMANDE.COMMANDE]: {
      backgroundColor: '#FFB74D',
      textColor: '#f5f5f5',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-command" viewBox="0 0 16 16">
    ...
    [IDS_STATUT_COMMANDE.ENCOURS_TRAITEMENT]: {
    ...
    [IDS_STATUT_COMMANDE.EN_ATTENTE_TRAITEMENT]: {
    ...
    [IDS_STATUT_COMMANDE.ENTENTE_LIVRAISON]: {
