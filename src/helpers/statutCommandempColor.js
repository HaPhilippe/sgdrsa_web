...
import IDS_STATUT_COMMANDEMP_STATUTS from "../constants/IDS_STATUT_COMMANDEMP_STATUTS.js"

export default function statutCommandempColor(idStatut) {
  const defaultColor = {
  ...
  const COLORS = {
    ...
    [IDS_STATUT_COMMANDEMP_STATUTS.ENCOURS]: {
    ...
    [IDS_STATUT_COMMANDEMP_STATUTS.ENATTENTE_APPROBATION]: {
    ...
    [IDS_STATUT_COMMANDEMP_STATUTS.ENTENTE_PAYEMENT]: {
    ...
    [IDS_STATUT_COMMANDEMP_STATUTS.PAYE]: {
    ...
    [IDS_STATUT_COMMANDEMP_STATUTS.ANNULER]: {
